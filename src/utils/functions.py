...
def retrieve_match_schedule() -> DataFrame:
    ...
    if event_matches:
        ...
        with open("/mount/src/falconvis/src/data/match_schedule.json") as file:
            ...
            [
                {
                    ...
                    "reached_coop": (
                        match["score_breakdown"]["red"]["coopertitionCriteriaMet"] and match["score_breakdown"]["blue"]["coopertitionCriteriaMet"]
                    )
                }
