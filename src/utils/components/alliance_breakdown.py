...
def alliance_breakdown(
    ...
    """
    with (
        open("./utils/components/alliance_breakdown_component.html") as html_file,
        open("./utils/components/defense_svg.html") as defense_svg_file,
        open("./utils/components/offense_svg.html") as offense_svg_file
    ):
