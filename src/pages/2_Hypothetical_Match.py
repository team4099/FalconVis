"""Creates the page for hypothetical match graphs, allowing the user to choose the teams."""
...
if __name__ == '__main__':
    st.write("# Hypothetical Match")

    teams_selected = match_manager.generate_hypothetical_input_section()
