...
const Selections =  {
    MATCHES: ["qm1", "qm2", "qm3", "qm4", "qm5", "qm6", "qm7", "qm8", "qm9", "qm10", "qm11"],
    TEAMS: [33, 2056, 4499, 2468, 4099, 118, 180, 340, 5406],
    RED: "Red",
    BLUE: "Blue"
}

const JSONData = "https://raw.githubusercontent.com/team4099/FalconVis/match-ui/src/lib/data/iri_data.json"
